...
def create_folder_of_summaries(folder_path):
    ...
    for file in files:
        ...
        if not summary_path.exists():
            ...
            summary = ''
            docs = SimpleDirectoryReader(input_files=[os.path.join(folder_path,file)]).load_data()
            for doc in docs:
...
if __name__ == "__main__":
    folder_path = './data/judgements_docx'
